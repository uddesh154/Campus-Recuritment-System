...
try{
	...
	String sql ="select * from job where location='"+b1+"' and area='"+b2+"' and key='"+b3+"'";
...
<tr>
	...
	<tr>
	<td><FONT SIZE="4"COLOR="blue" FACE="roman">Vacancies:<%out.println(rs.getInt(3));%></FONT><br>
	</td></tr>
	<tr><td><FONT SIZE="4"COLOR="blue" FACE="roman">Salary:   <%out.println(rs.getInt(4));%></FONT><br></td></tr>
